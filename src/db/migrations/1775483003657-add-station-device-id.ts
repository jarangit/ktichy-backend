...
export class AddStationDeviceId1775483003657 implements MigrationInterface {
    name = 'AddStationDeviceId1775483003657'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`station\` ADD \`device_id\` varchar(10) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`station\` DROP COLUMN \`device_id\``);
